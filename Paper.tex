...
We evaluate the method on two Korean corpora and four Mandarin domain subsets. \corpA{} contains 59{,}054 utterances from a financial counselling subset of AI-Hub
\emph{Counselling Speech}. \corpB{} contains 51{,}898 utterances from the validation split of AI-Hub
\emph{Medical Staff and Patient Speech}. The corresponding evaluation pools contain 34{,}500 and 34{,}334 utterances. \corpA{} provides 493 speaker identifiers. \corpB{} provides no speaker identifiers, so its 81 source folders are used for exemplar exclusion and grouped evaluation; these folders do not guarantee speaker separation.
